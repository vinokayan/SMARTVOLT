...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/smartvolt-auth-v3.css') }}?v=20260730">
</head>
        ...
        >
            ...
            <div class="sv-auth-showcase-content">
                ...
                <div class="sv-auth-copy">
                    ...
                    <h1>
                        Energi rumah, lebih mudah dikendalikan.
                    </h1>
                ...
                <div class="sv-auth-benefits">
                    ...
                    <article class="sv-auth-benefit">
                        ...
                        <div>
                            <h2>Kontrol dalam satu tempat</h2>
                            <p>
