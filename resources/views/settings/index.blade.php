...
<body class="sv-dashboard-body">
                    ...
                    <div class="sv-hero-card sv-glass" style="padding: 28px;">
                        <div>
                            ...
                            <p style="color: #cfe3ff; line-height: 1.7; max-width: 760px;">
                                Pilih pengaturan akun atau buka mode teknisi untuk mengelola ruangan, sensor listrik, ESP, dan relay.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="sv-settings-grid">
                        <div class="sv-feature-card sv-glass js-open-account-modal">
                            <div>
                                ...
                                <p>Ubah nama, email, dan password akun.</p>
                            </div>
                        ...
                        <div class="sv-feature-card sv-glass js-open-tech-or-pin">
                            <div>
                                ...
                                <p>Mode teknisi untuk mengelola ruangan, sensor listrik, ESP, dan relay.</p>
                            </div>
    ...
    <div id="accountModal" class="sv-modal">
        <div class="sv-modal-head">
            <div>
                <h3>Pengaturan Akun</h3>
                <div class="sv-panel-sub">Ubah nama, email, dan password.</div>
            </div>

            <button type="button" class="sv-close-btn js-close-account-modal">
    ...
    <div id="pinModal" class="sv-modal sv-pin-modal">
        <div class="sv-modal-head">
            <div>
                <h3>Mode Teknisi</h3>
                <div class="sv-panel-sub">Masukkan PIN untuk membuka konfigurasi sistem.</div>
            </div>

            <button type="button" class="sv-close-btn js-close-pin-modal">
                <i class="bi bi-x-lg"></i>
            </button>
        </div>
        ...
        <form action="{{ route('advanced-mode.enable') }}" method="POST" class="sv-form-stack">
            ...
            <div class="sv-form-group">
                <label class="sv-form-label">PIN Teknisi</label>
            ...
            <div class="sv-tech-container">
                <div class="sv-tech-card">
                    <div class="sv-tech-head">
                        ...
                        <button type="button" class="sv-close-btn js-close-tech-panel">
                            <i class="bi bi-x-lg"></i>
                        </button>
                    </div>
                        ...
                        <div class="sv-tech-section sv-tech-sidebar">
                            ...
                            <div class="sv-block-title" style="margin-bottom: 0;">
                                ...
                                <div>
                                    ...
                                    <p>Pilih ruangan untuk melihat sensor listrik dan relay.</p>
                                </div>
                            </div>
                            ...
                            <div class="sv-room-list">
                                @forelse($roomsForDevice as $room)
                                    ...
                                    >
                                        <button type="button" class="js-show-tech-room" data-room-id="{{ $room->id }}">
                                            <h4>{{ $room->name }}</h4>
                                ...
                                >
                                    <div>
                                        ...
                                        <div class="sv-tech-toolbar">
                                            <button type="button" class="sv-secondary-btn js-toggle-tech-box" data-target="edit-room-{{ $room->id }}">
                                                <i class="bi bi-pencil-square"></i>
                                                Ubah Ruangan
                                            </button>

                                            <button type="button" class="sv-primary-btn js-toggle-tech-box" data-target="add-sensor-{{ $room->id }}">
                                                <i class="bi bi-cpu-fill"></i>
                                                Tambah ESP + Sensor Listrik
                                            </button>

                                            <button type="button" class="sv-success-btn js-toggle-tech-box" data-target="add-relay-{{ $room->id }}">
                                                <i class="bi bi-toggle-on"></i>
                                                Tambah Relay
                                            </button>
                                        ...
                                        <div id="add-sensor-{{ $room->id }}" class="sv-edit-panel">
                                            ...
                                            <form action="{{ route('technician.rooms.sensor.store', $room->id) }}" method="POST" class="sv-form-stack">
                                                @csrf
                                        ...
                                        <div id="add-relay-{{ $room->id }}" class="sv-edit-panel">
                                            ...
                                            @if($roomSensors->isNotEmpty())
                                                <form action="{{ route('technician.rooms.relay.store', $room->id) }}" method="POST" class="sv-form-stack">
                                                    @csrf
                                                ...
                                                <div class="sv-info-card sv-sensor-card">
                                                    <div class="sv-card-head">
                                                        ...
                                                        <div class="sv-tech-toolbar" style="margin-bottom: 0;">
                                                            <button type="button" class="sv-secondary-btn js-toggle-tech-box" data-target="edit-sensor-{{ $sensor->id }}">
                                                                <i class="bi bi-pencil-square"></i>
                                                                Ubah
                                                            </button>
                                                    ...
                                                    <div id="edit-sensor-{{ $sensor->id }}" class="sv-edit-panel">
                                                        ...
                                                        <form action="{{ route('technician.sensors.update', $sensor->id) }}" method="POST" class="sv-form-stack">
                                                            @csrf
                                                            @method('PUT')
                                            ...
                                            @forelse($roomDevices as $device)
                                                <div class="sv-info-card">
                                                    <div class="sv-card-head">
                                                        ...
                                                        <div class="sv-tech-toolbar" style="margin-bottom: 0;">
                                                            <button type="button" class="sv-secondary-btn js-toggle-tech-box" data-target="edit-device-{{ $device->id }}">
                                                                <i class="bi bi-pencil-square"></i>
                                                                Ubah
                                                            </button>
                                                    ...
                                                    <div class="sv-summary-grid three">
                                                        <div>
    ...
    <script>
        ...
        function updateRelayInputs(roomId, count) {
            ...
            inputs.forEach(function (input) {
                ...
                input.style.display = channel <= max ? '' : 'none';
            });
        }
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.js-close-tech-panel').forEach(function (button) {
                button.addEventListener('click', closeTechPanel);
            });
