...
Write-Host ""
Write-Host "SmartVolt UI V6 - Streamlined UX" -ForegroundColor Cyan
...
$BackupRoot = Join-Path $ProjectRoot "storage\ui-backups\v6-streamlined-$Timestamp"
...
Write-Host ""
Write-Host "Pemasangan SmartVolt UI V6 berhasil." -ForegroundColor Green
