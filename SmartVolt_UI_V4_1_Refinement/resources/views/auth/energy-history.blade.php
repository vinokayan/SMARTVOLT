...
@section('content')
    ...
    <section class="sv-history-metrics" aria-label="Ringkasan pemakaian listrik">
        <article class="sv-history-metric sv-history-metric-blue is-primary">
        ...
        <article class="sv-history-metric sv-history-metric-orange">
        ...
        <article class="sv-history-metric sv-history-metric-cyan">
