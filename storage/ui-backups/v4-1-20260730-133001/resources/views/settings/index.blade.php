                                ...
                                @foreach($roomCollection as $room)
                                    ...
                                    <details class="sv-tech-room" id="room-{{ $room->id }}" {{ $selectedRoomId === $room->id || $loop->first ? 'open' : '' }}>
                                        ...
                                        <div class="sv-tech-room-content">
                                            <section class="sv-tech-subsection sv-tech-subsection-room">
                                            ...
                                            <section class="sv-tech-subsection sv-tech-subsection-create">
                                                <div class="sv-tech-subsection-head">
                                            ...
                                            @if($roomEspIds->isNotEmpty())
                                                <section class="sv-tech-subsection sv-tech-subsection-relay-create">
                                            ...
                                            <section class="sv-tech-subsection sv-tech-subsection-list sv-tech-subsection-sensors">
                                            ...
                                            <section class="sv-tech-subsection sv-tech-subsection-list sv-tech-subsection-devices">
