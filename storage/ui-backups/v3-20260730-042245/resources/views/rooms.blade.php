...
@section('content')
    <div class="sv-page-heading">
        <div class="sv-page-heading-copy">
            ...
            <p>Switch hanya aktif ketika ESP32 pada perangkat tersebut sedang mengirim data terbaru.</p>
        </div>
        ...
        <section class="sv-card">
            <div class="sv-card-body">
                <div class="sv-empty-state">
                    ...
                    <p>Tambahkan ruangan terlebih dahulu melalui Mode Teknisi, lalu daftarkan ESP32, sensor PZEM, dan relay.</p>
                    ...
                    <div class="sv-room-card-body">
                        ...
                        @empty
                            <div class="sv-empty-state">
                                ...
                                <p>Daftarkan sensor dan relay pada ruangan ini melalui Mode Teknisi.</p>
                            </div>
                        @endforelse
                    </div>
